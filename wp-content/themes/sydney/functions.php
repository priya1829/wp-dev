...
function handle_contact_form_submission() {
    if( isset($_POST['action']) && $_POST['action'] === 'submit_contact_form' ) {
        ...
        $subject = sprintf("New message from %s", $name);
        ...
        // Optionally, send a copy of the email to the sender
        // Customize the email subject and body for the sender
        $sender_subject = "Confirmation: Your message to " . get_bloginfo('name');
        $sender_body = "Dear " . $name . ",\n\n";
        $sender_body .= "Thank you for contacting us. We have received your message and will get back to you shortly. Best regards, BloomskillTech:\n\n";
       

        // Send the email to the sender
        wp_mail($email, $sender_subject, $sender_body);
